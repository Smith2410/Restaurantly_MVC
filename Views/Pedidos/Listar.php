            ...
            sideBar();
                ...
                {   ?>
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-outline-info" href="<?php echo base_url() ?>pedidos/entregados">
                                        <i class="icofont-navigation-menu"></i> Entregados
                                    </a>
                                </div>
                                            ...
                                            <?php foreach ($data as $cl) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-secondary" href="<?php echo base_url() ?>detalles/ver?numPedido=<?php echo $cl['numPedido']; ?>">
