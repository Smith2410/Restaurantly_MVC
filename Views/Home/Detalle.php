    ...
    <div class="container" data-aos="fade-up">
        <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-2 content">
                ...
                {
                    ?>
                    <form action="<?php echo base_url(); ?>Platillos/carrito" method="POST" data-form="">
                        <input type="hidden" value="<?php echo $data['codigo'] ?>" id="codigo" name="codigo">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-outline-warning"><i class="bi bi-cart"></i>&nbsp;&nbsp; Añadir al carrito</button>
                ...
                <div>
                    <a class="btn btn-outline-warning" href="<?php echo base_url(); ?>Home/platillos">Ir a platillos</a>
                </div>
            </div>
        </div>
    </div>
